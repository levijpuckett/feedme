...
#    pg.draw.rect(surface, start_colour, start_rect)
    pg.display.flip()
...
#        self.danger = pg.image.load(danger_icon)
#        self.danger = pg.transform.scale(self.danger, icon_size)
#        self.dangerrects = []
#        for i in range(num_danger):
#            rect = self.avoid_collisions(self.danger, creatures, screen_size, icon_size)
#            if rect:
#                self.dangerrects.append(rect)
...
#        for dangerrect in self.dangerrects:
#            surface.blit(self.danger, dangerrect)
#        if self.deadrects:
#            for deadrect in self.deadrects:
#                surface.blit(self.dead, deadrect)
#        surface.blit(self.env_surf, self.env_rect)
